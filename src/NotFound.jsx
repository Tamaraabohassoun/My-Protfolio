...
//   return (
//     <section className="relative w-full min-h-screen bg-transparent text-white overflow-hidden flex items-center justify-center">
//       {/* خلفية LightPillar */}
...
//       {/* المحتوى الرئيسي */}
//       <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full max-w-4xl mx-auto " data-aos="fade-up">
//         {/* 404 */}
//         <div className="mb-6!">
...
//         <p className="text-gray-300 text-lg md:text-xl font-semibold max-w-xl mx-auto mb-2!">
  ...
  return (
    <section className="relative w-full min-h-screen text-white overflow-hidden flex items-center justify-center" style={{ backgroundColor: '#1e0a41!' }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="200">
        {/* 404 مع تدرج متحرك وظل خارجي غامق */}
        ...
        {/* Lost in Space مع ظل خارجي غامق */}
